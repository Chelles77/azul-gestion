                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {filteredResults.map((result) => {
                      const salePrice30 = result.priceNeuf * 0.70;
                      const salePrice25 = result.priceNeuf * 0.75;
                      return (
                    ...
                    <tr className="bg-[#0a0a0a] border-t-2 border-gray-600 font-bold">
                      ...
                      <td className="px-4 py-3 text-sm text-green-400">{filteredResults.reduce((sum, r) => sum + (r.priceNeuf * 0.70), 0).toFixed(2)} €</td>
                      <td className="px-4 py-3 text-sm text-cyan-400">{filteredResults.reduce((sum, r) => sum + (r.priceNeuf * 0.75), 0).toFixed(2)} €</td>
